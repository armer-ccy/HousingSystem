...
class JPanel_Window(windowDoorData: WindowDoorData, modelCB: DefaultComboBoxModel<String>) : JPanel(), ActionListener {
    val label = arrayOf(
                        ...
                        txtfield[3].text.toDoubleOrNull()?.let { it4 ->
                            ...
                            Add(
                                windowDoorData, WindowDoorData(
                                    ++windowDoorData.id, str.substring(0, str.indexOf(',')).toInt(), 1,
                                    it1, it2, it3, it4
                                )
                            )
                        }
